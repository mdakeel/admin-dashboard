...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const storedProfilePic = localStorage.getItem('profilePic') || 'url/to/default/profile.png';
      ...
      <div className='md:px-8 px-10 flex items-center justify-between'>
        ...
        <div className='flex md:w-[25%] w-full items-center md:justify-end justify-between gap-6'>
          ...
          <div className='flex items-center gap-2'>
            <img src={profilePic} alt="profile img" className='md:w-9 md:h-9 w-8 h-8 rounded-full cursor-pointer' />
            <p className='md:text-[19px] text-[17px] text-gray-600'>{username}</p>
          </div>
          <IoMdLogOut
